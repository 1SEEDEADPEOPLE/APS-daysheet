...
| Version | Notes |
|---------|-------|
| v4.2.3 | New Leave Request form (Annual/Sick/LWOP/Bereavement/Other, green theme, employee signature, APS-formatted PDF); fixed backup banner layout; fixed PM/Client autocomplete in all forms; fixed partial-name contact saving |
